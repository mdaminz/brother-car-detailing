        ...
        <tbody>
            @foreach ($bookings as $booking)
                <tr>
                    ...
                    <td>{{$booking->complete_status}}</td>
                    <td style="text-align: center;" class="table-action">
                        <a href="{{url('stripe', $booking->id)}}"><i class="align-middle fa fa-envelope"></i></a>
                        <a href="{{url('show_receipt', $booking->id)}}"><i class="align-middle fas fa-fw fa-trash"></i></a>
                    </td>
                </tr>
            @endforeach
        </tbody>
